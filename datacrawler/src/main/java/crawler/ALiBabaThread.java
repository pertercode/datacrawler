...
import dao.BaseDao;
import services.ALiBaBaService;
 ...
 * 云筑商城抓取数据
 */
public class ALiBabaThread implements Runnable {

    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ALiBabaThread.class);

    private static final String platform = ALiBaBaService.platform;
